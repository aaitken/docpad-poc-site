...
module.exports = function(BasePlugin) {
  var SassPlugin, TaskGroup, safeps, _ref;
  ...
  return SassPlugin = (function(_super) {
    ...
    function SassPlugin() {
      _ref = SassPlugin.__super__.constructor.apply(this, arguments);
      return _ref;
    }
    ...
    SassPlugin.prototype.render = function(opts, next) {
      var command, commandOpts, config, execPath, file, fullDirPath, inExtension, locale, name, outExtension, _i, _len, _ref1;
      config = this.config;
      locale = this.locale;
